...
export const BatikNFT_ABI = [
  ...
  'function getProductByHash(string _metadataHash) external view returns (tuple(uint256 tokenId, string productName, string producerName, string originRegion, string metadataHash, string photoUrl, uint256 timestamp, uint8 status, string distributorName, uint256 distributedAt))',
